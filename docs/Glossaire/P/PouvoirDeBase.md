...
Un pouvoir de base est une statistique qui permet à un personnage d'exécuter une fonction de jeu particulière.  

- Il existe cinq pouvoirs de base différents :  
...
<summary>EN v1.8</summary>BASIC POWER
...
See also: Ally, Attack (Enemy Activation), Attack (Player Ability Type), Defend, Identity, Minion, Modifiers, Recover, Recovery, Scheme (Enemy Activation), Thwart
</details>
