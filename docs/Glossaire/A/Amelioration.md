...
- Certaines améliorations entrent en jeu et « s’attachent à » une autre carte. Ces améliorations modifient la carte à laquelle elles sont attachées, pas le héros ou l’alter ego du joueur qui a joué cette amélioration.  
    - <span class="new">Un joueur contrôle toutes les améliorations attachées aux personnages qu’il contrôle, y compris les améliorations appartenant à un autre joueur.</span>  
...
_Voir aussi : [[AttacherCetteCarte|Attacher cette carte]], [[CartesJoueur|Carte Joueur]], [[EnJeuAndHorsJeu|En Jeu et Hors Jeu]], [[EntrerEnJeu|Entrer en Jeu]], [[Identite|Identité]], [[QuitterLeJeu|Quitter le Jeu]], [[TypesDeCarte|Types de Carte]], [[ZoneDeJeuDUnJoueur|Zone de Jeu d’un Joueur]]_  
