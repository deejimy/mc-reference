...
1. <span class="new">Si une carte est jouée, le joueur place cette carte face visible devant lui sur la table. (Cette carte n'est pas en jeu.)</span>  
2. Vérifier les restrictions de jeu : la carte peut‑elle être jouée ou la capacité initiée à ce moment ?  
    ...
    - <span class="new">Si la carte ou la capacité a une exigence de forme (par exemple, « Forme héros uniquement » ou « Action de héros »), la forme du joueur qui joue cette carte ou initie cette capacité est vérifiée maintenant.</span>  
