...
**Voir aussi** : Dégâts excédentaires, Mots-clés
...
Voir aussi : Allié, Attaque (Activation des Ennemis), Attaque (Action de Joueur), Dégâts, Identité, Méchant, Mots-clés, Points de Vie, Sbire, Texte de Rappel 12 Guide de Référence
```