...
Si le deck d'un joueur se vide, le joueur mélange sa pile de défausse pour former un nouveau deck. Ce joueur se distribue immédiatement une carte Rencontre face cachée du dessus du deck Rencontre.

  - Si le deck d'un joueur se vide et est remélangé alors qu'il piochait des cartes, le joueur continue de piocher jusqu'au nombre spécifié.

  - Si le deck d'un joueur se vide alors qu'il défaussait des cartes de son deck, aucune autre carte n'est défaussée du deck nouvellement mélangé.

  - Si le deck d'un joueur se vide et qu'il n'a aucune carte dans sa pile de défausse, le deck n'est pas réinitialisé tant qu'il n'y a pas au moins une carte dans la pile de défausse ; à ce moment, le joueur se distribue une carte Rencontre face cachée.
...
player was drawing cards, the player continues to
...
discarded from the newly shuffled deck.
  ...
  - If a player deck empties and the player has no cards
in their discard pile, the deck does not reset until
there is at least one card in the player’s discard
pile, then the player deals themself one facedown
encounter card.
