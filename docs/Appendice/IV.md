...
<span class="new">**Q : Si mon allié avec une carte d'état Tenace subit des dégâts de déferlement, les dégâts en excès sont-ils infligés à mon identité ?**
R : Non. Seuls les dégâts en excès *subis* par l'allié sont infligés à l'identité par le mot-clé *déferlement*, et une carte d'état Tenace empêche le personnage de *subir* des dégâts.</span>
