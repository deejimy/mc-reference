# Vérficiation des fichiers

Le but est de vérifier la traduction de chaque fichier inclus dans /docs/Glossaire/*/*.md
...
7. En cas d'erreur, lister la phrase avec la cause : oubli | puces | phrase en trop dans le fichier .instructions/fix.md
